$(() => {
	...
	function marcacaoDeLinksNoScroll() {
		...
		if (window.scrollY >= 0) {
			...
			$(".w3-links-js").eq(0).addClass("w3-blue-edited");
		}
		...
		if (window.scrollY >= (parteUmAltura + parallaxUmAltura-50)) {
			...
			// adiciona o marcador apenas ao link do menu que corresponde
			$(".w3-links-js").eq(1).addClass("w3-blue-edited");
		}
		...
		if (window.scrollY >= (
			...
			// adiciona o marcador apenas ao link do menu que corresponde
			$(".w3-links-js").eq(2).addClass("w3-blue-edited");
		} 
		...
		if (window.scrollY >= (
			...
			// adiciona o marcador apenas ao link do menu que corresponde
			$(".w3-links-js").eq(3).addClass("w3-blue-edited");
		} 
	}
